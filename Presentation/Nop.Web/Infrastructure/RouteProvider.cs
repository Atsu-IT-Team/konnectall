...
namespace Nop.Web.Infrastructure
{
    ...
    public partial class RouteProvider : BaseRouteProvider, IRouteProvider
    {
        ...
        public void RegisterRoutes(IEndpointRouteBuilder endpointRouteBuilder)
        {
            ...
            //change selected product in deal Of The day (shop page). (AJAX)
            endpointRouteBuilder.MapControllerRoute(name: "LoadDealOfTheDayComponent",
                pattern: $"loadDealOfTheDay/{{selectedProductId:min(0)}}",
                defaults: new { controller = "ShopController", action = "LoadDealOfTheDayComponent" });
