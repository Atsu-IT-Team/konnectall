...
namespace Nop.Plugin.Api.DTO.OrderItems
{
    ...
    public class OrderItemDto : BaseDto
    {
        ...
        private ICollection<WarehouseForShipmentDto> _warehouses;

        /// <summary>
        ///     Gets or sets Warehouses for Shipment
        /// </summary>
        [JsonProperty("product_warehouses")]
        public ICollection<WarehouseForShipmentDto> Warehouses
        {
            get
            {
                if (_warehouses == null)
                {
                    _warehouses = new List<WarehouseForShipmentDto>();
                }
